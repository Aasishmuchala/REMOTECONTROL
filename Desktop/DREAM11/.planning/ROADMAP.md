...
- [x] 02-03-PLAN.md — GREEN Client: Socket client singleton + useOrderBook + usePriceFeed + useRecentTrades hooks
- [x] 02-04-PLAN.md — WIRE: OrderBookTable + RecentTrades components + trade page rewire + visual verification
...
Plans:
- [x] 03-01-PLAN.md — Wire OrderForm slippage from live book, post-order refresh, OpenOrders 5s auto-refresh + tests
